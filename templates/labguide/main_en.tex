% =====================================================================
%  Lab Guide — English sample (verifies all template features)
%  Compile with XeLaTeX:
%      xelatex main_en.tex   (run 2x for the TOC)
% =====================================================================
\documentclass[english]{labguide}

% --- Document configuration -----------------------------------------
\setlabtitle{Lab Guide: Getting Started with Huawei Cloud ECS}
\setheadertitle{Huawei Cloud -- ECS Quick Start Lab}
...
\nota{This lab is an English sample that exercises every command and
  environment provided by the \code{labguide} class. Use it as a reference
  when writing your own lab guides.}
