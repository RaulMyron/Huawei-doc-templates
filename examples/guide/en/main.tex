...
\begin{enumerate}
  ...
  \imagecap{assets/exemplo-menu.png}{Service catalog in the Console.}
...
Security Group: sg-ssh (allows inbound TCP 22)
  ...
  \image{assets/exemplo-login.png}
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|l|l|}
    \rowcolor{huaweired}
    \thd{Flavor} & \thd{vCPU / RAM} & \thd{Use case} \\
    \midrule
    \tbody
...
\begin{changelog}
  \changelogentry{1.1.5}{2026-08-09}{
  ...
  \changelogentry{1.1.4}{2026-08-09}{
  ...
  \changelogentry{1.1.2}{2026-08-08}{
    \item Fixed stale class options comment in file header.
  }
