...
| `\setdocdate{2025-08-06}` | Sets the **date** shown on the cover page next to the version. |
...
| `\setdocdate{2025-08-06}` | Shows the date on the cover page next to the version. |
