...
scaffold_guide() {
    ...
    cat > "$PROJECT_DIR/.latexmkrc" <<'LATEXMKRC'
...
\\end{document}
TEX
    log_ok "Created main.tex, .latexmkrc, assets/"
    log_dim "Next: cd documents/$NAME && latexmk main.tex"
}
