% =====================================================================
%  Guia de Laboratório — exemplo de uso do template labguide.cls
%  Compilar com XeLaTeX ou LuaLaTeX:
%      xelatex main.tex   (rode 2x para o sumário)
%
%  Para versão em inglês, use:  \documentclass[english]{labguide}
% =====================================================================
\documentclass{labguide}

% --- Configuração do documento --------------------------------------
\setlabtitle{Guia de Laboratório: Acessar o Console da Huawei Cloud}
\setheadertitle{Huawei Cloud -- Guia do laboratório sobre acesso ao Console}
...
\nota{Este laboratório é um exemplo de uso do template \code{labguide.cls};
  ajuste os textos, imagens e blocos de código conforme o fluxo real do seu
  laboratório.}
