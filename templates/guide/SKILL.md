...
| `\setdocdate{2026-08-06}` | Document date, shown on the cover page next to the version. |+| ### Document structure
| Command | Purpose |
|---|---|
...
| `\setdocdate{2026-08-06}` | Sets the date shown on the cover page. |
