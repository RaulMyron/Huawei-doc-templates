...
\begin{enumerate}
  ...
  \imagecap{assets/ecs-reset-password.png}{Reset Password option in the ECS
    details page.}
...
\begin{enumerate}
  ...
  \imagecap{assets/ecs-remote-login.png}{Remote Login button in the ECS
    details page.}
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|l|l|}
    \rowcolor{huaweired}
    \thd{Step} & \thd{What to check} & \thd{Expected result} \\
    \midrule
    \tbody
...
\begin{changelog}
  \changelogentry{2.2.5}{2026-08-09}{
    \item Fixed PDF copy-paste of indentation in code blocks — added
          \texttt{/ActualText} markers so PDF viewers preserve leading spaces.
  }
  ...
  \changelogentry{2.0.0}{2026-08-05}{
    ...
    \item Fixed \inlinecode{\textbackslash codigoarquivo} implementation for
