...
\begin{enumerate}
  ...
  \imagecap{assets/exemplo-login.png}{Tela de login do Console.}
...
\begin{table}[h]
  ...
  \begin{tabular}{|l|l|l|}
    \rowcolor{huaweired}
    \thd{Região} & \thd{Localidade} & \thd{Código} \\
    \midrule
    \tbody
...
\begin{changelog}
  \changelogentry{1.1.4}{2026-08-09}{
    \item Corrigida cópia de indentação em blocos de código — adicionados
          marcadores \texttt{/ActualText} para preservar espaços iniciais.
  }
